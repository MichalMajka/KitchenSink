        ...
        public static void Create()
        {
            Db.Transact(() =>
            {
                ...
                if(Db.SQL("SELECT p FROM KitchenSink.Person p").First == null) {
                    new Person { Name = "Allan", SequenceNumber = 0 };
                    new Person { Name = "Joe", SequenceNumber = 1 };
                    new Person { Name = "Alex", SequenceNumber = 2 };
                    new Person { Name = "Arthur", SequenceNumber = 3 };
                    new Person { Name = "Conan", SequenceNumber = 4 };
                    new Person { Name = "Agatha", SequenceNumber = 5 };
                    new Person { Name = "Terry", SequenceNumber = 6 };
                    new Person { Name = "Albreht", SequenceNumber = 7 };
                }
            });
        }
    }
